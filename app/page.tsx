          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                Help improve your city by reporting infrastructure issues. From
                potholes to broken lights, your reports make a difference.
              </p>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Streamline civic reporting with AI-powered classification and
              community voting.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 rounded-xl bg-background border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">
                AI automatically categorizes issues (potholes, lighting,
                drainage, etc.) for faster resolution.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-background border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">
                Vote on issue urgency to help prioritize which problems get
                fixed first.
              </p>
            </div>
            ...
            <div className="p-6 rounded-xl bg-background border border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground text-sm">
                Attach photos with your report to provide clear evidence of
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            { step: 2, title: "Report", desc: "Capture and report an issue" },
            {
              ...
              desc: "System classifies the issue",
            },
            {
              step: 4,
              title: "Vote & Track",
              desc: "Community votes & tracks progress",
            },
          ].map((item) => (
      ...
      <footer className="border-t border-border bg-card/50 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-muted-foreground text-sm">
            <p>
              © {new Date().getFullYear()} CityReport. Making cities better
